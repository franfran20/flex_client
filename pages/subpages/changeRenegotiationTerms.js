...
export default function changeRenegotiationTerms() {
  ...
  const { runContractFunction: changeRenegotiationTerms } = useWeb3Contract({
    abi: FLEX_CORE_ABI,
    contractAddress: FLEX_CORE_ADDRESS,
    functionName: "change_renegotiation_terms",
    params: {
      _loan_id: loanId,
      ...
      <div className={styles.proposeNewTerms}>
        <div className={styles.text}>
          <Image
            ...
            height="1000"
          />
          <h3>Change Initial Renegotiation</h3>
          <p>
        ...
        <div className={styles.proposeForm}>
          ...
          <button
            onClick={() => changeRenegotiationTerms()}
